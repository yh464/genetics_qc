...
for dataset in gw15 gw20 gw22 gw34; do
  gsmap run_find_latent_representations --workdir /rds/project/rds-Nl99R8pHODQ/multiomics/gsmap --sample_name qian_2025_$dataset \
    --input_hdf5_path /rds/project/rds-Nl99R8pHODQ/multiomics/raw/qian_2025/${dataset}_full.h5ad --annotation annotation --data_layer count
  gsmap run_latent_to_gene --workdir --workdir /rds/project/rds-Nl99R8pHODQ/multiomics/gsmap --sample_name qian_2025_$dataset \
    --annotation annotation --latent_representation latent_GVAE --num_neighbour 51 --num_neighbour_spatial 201
  for chrom in {1..22}; do
    gsmap run_generate_ldscore --workdir /rds/project/rds-Nl99R8pHODQ/multiomics/gsmap --sample_name qian_2025_$dataset \
